...
var enemies = [
  ...
  {x:16340, y:460, w:60, h:100, vx: 0, vy: 0, dead: false, room: 20, type: 'abyssal_knight',
    boss: true, bossName: "CABALLERO ABISMAL", hp: 440, maxHp: 440, aiTimer: 70, attackTimer: 50, phase: 1, enraged: false},
  {x: 42 * ROOM_W + 360, y: 560, w: 110, h: 120, vx: 0, vy: 0, dead: false, room: 42, preserveRoom: true, type: 'dragon',
    boss: true, bossName: "DRAGÓN DEL VACÍO", hp: 900, maxHp: 900, aiTimer: 80, attackTimer: 55, phase: 1, enraged: false},
  {x: 40 * ROOM_W + 210, y: 538, w: 28, h: 22, vx: 1.2, vy: 0, baseY: 538, speed: 1.5, dead: false, room: 37, type: 'larva_mosca'},
  {x: 40 * ROOM_W + 420, y: 538, w: 34, h: 48, vx: -1, vy: 0, baseY: 512, speed: 1.1, dead: false, room: 37, type: 'dark_knight', hp: 48, maxHp: 48, blockTimer: 80, dashCooldown: 100, dashTimer: 0, staysRoom: true},
  {x: 40 * ROOM_W + 650, y: 400, w: 24, h: 20, vx: -1.3, vy: 0, baseY: 400, range: 70, dead: false, room: 37, type: 'bat'},
